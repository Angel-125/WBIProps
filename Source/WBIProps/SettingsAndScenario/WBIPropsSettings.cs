...
namespace WBIProps
{
    public class WBIPropsSettings : GameParameters.CustomParameterNode
    {
        ...
        public static bool EnableDebugLogging
        {
            get
            {
                WBIPropsSettings settings = HighLogic.CurrentGame.Parameters.CustomParams<WBIPropsSettings>();
